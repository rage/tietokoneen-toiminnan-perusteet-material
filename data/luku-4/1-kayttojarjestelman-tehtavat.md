...
<div>
<illustrations motive="ch-4-1-kj-kaksi-tasoa-draft" frombottom="0" totalheight="30%"></illustrations>
</div>
...
-- Quiz 4.1.1 Mitä käyttöjärjestelmä tekee sillä aikaa kun suoritin suorittaa käyttäjän ohjelmaa? ei mitään, tarkkailee laitteita virheiden varalta, tarkkailee verkkoa, josko sieltä tulisi paketti, jne
<div><quiznator id="5c371b7514524713f959c80d"></quiznator></div>

-- Quiz 4.1.2 Mitä etua saadaan sillä, että käyttöjärjestelmä jaetaan kahteen kerrokseen, joista ylempi taso sisältää käyttäjätason toiminnot ja alempi taso etuoikeutetussa tilassa suoritettavat laitteistotason toiminnot? ei mitään, helpompi toteuttaa luotettava käyttöjärjestelmä, helpompi toteuttaa samanlaiset käyttöliittymät eri laitteille, helpompi siirtää käyttöjärjestelmä uuteen tietokonejärjestelmään, käyttöjärjestelmäpalvelujen toteutus on helpompaa
<div><quiznator id="5c372a6214524713f959c84b"></quiznator></div>


-- Quiz 4.1.3 Mitä haittaa on siitä, että käyttöjärjestelmä jaetaan kahteen kerrokseen, joista ylempi taso sisältää käyttäjätason toiminnot ja alempi taso etuoikeutetussa tilassa suoritettavat laitteistotason toiminnot? ei mitään, vaikeampi toteuttaa luotettava käyttöjärjestelmä, hidastaa käyttöjärjestelmän suoritusta
