...
<div>
<illustrations motive="ch-4-3-ajuri-etuoik-aliohj-draft" frombottom="0" totalheight="60%"></illustrations>
</div>
...
<div>
<illustrations motive="ch-4-3-ajuri-user-etuoik-aliohj-draft" frombottom="0" totalheight="60%"></illustrations>
</div>
...
<div>
<illustrations motive="ch-4-3-ajuri-stub-etuoik-prosessi-draft" frombottom="0" totalheight="60%"></illustrations>
</div>



-- Quiz 4.3.1. Mitä etua on sillä, että tietty käyttöjärjestelmän palvelu on toteutettu prosessina eikä aliohjelmana?
<div><quiznator id="5c35e4fdddb6b814af31d29d"></quiznator></div>

-- Quiz 4.3.2. Mitä etua on sillä, että tietty käyttöjärjestelmän palvelu on toteutettu aliohjelmana eikä prosessina?
<div><quiznator id="5c35e91e99236814c5bb3e64"></quiznator></div>

-- Quiz 4.3.3. Mitä merkitys on sillä, että tietty sovellus ei tiedä, onko jokin käyttöjärjestelmän palvelu toteutettu prosessina tai aliohjelmana?
<div><quiznator id="5c35eb1bfd9fd71425c5deff"></quiznator></div>

-- Quiz 4.3.4. Jos jokin käyttöjärjestelmän hallintotehtävä on toteutettu aliohjelmana, niin kuinka taataan, että se suoritetaan tarpeeksi usein?
<div><quiznator id="5c35ed8a99236814c5bb3e78"></quiznator></div>

-- Quiz 4.3.5. Mitä etua on siitä, että jokin käyttöjärjestelmän hallintotehtävä on toteutettu oamna prosessinaan?
