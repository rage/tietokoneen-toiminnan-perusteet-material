...
<div>
<lead>Tässä aliluvussa esittelemme prosessin käsitteen. Prosessi on järjestelmässä oleva suorituksessa olevan ohjelma ja prosessin kuvaaja sen esitysmuoto käyttöjärjestelmässä. Käymme myös läpi erilaiset tilat, joissa prosessi voi järjestelmässä olla ja minkälaisia tietoja prosessin kuvaajassa on.</lead>
</div>
