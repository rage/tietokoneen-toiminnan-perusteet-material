---
path: '/luku-3/2-kokonaislukuvut-ja-liukuluvut'
...
<pre>+57 = 0011 1001 = 0x39 (tavuna)     +57 = 0x 00 00 00 39 (32-bittisenä sanana)
...
<pre>               +57 = 0011 1001 = 0x39
komplementoi         1100 0110
lisää 1                     +1
               -57 = 1100 0111 = 0xC7
</pre>
Vasemmanpuolimmainen bitti on edelleenkin etumerkkinä. Negatiivisen luvun suuruus (vastaava positiivinen arvo, itseisarvo) saadaan sen esitysmuodosta ehkä vähän yllättäen samalla tavalla, komplementoimalla kaikki bitit ja lisäämällä 1.
<pre>               -57 = 1100 0111
...
<pre>Luku            57 = 0011 1001
vakiolisäys   +127 = 0111 1111
esitysmuoto    184 = 1011 1000 = 0xB8 = +57

Luku           -57
vakiolisäys   +127
esitysmuoto     70 = 0100 0110 = 0x46 = -57
</pre>
Kun vakiolisäyksenä käytetään 2<sup>n-1</sup>-1, niin esitystavalla on kaksikin etua. Ensinnäkin, positiivisilla ja negatiivisilla luvuilla on suunnilleen yhtä iso arvoalue. Toiseksi, vasemmanpuolimmainen bitti toimii myös etumerkkinä. Toisin kuin aikaisemmissa esitysmuodoissa, etumerkkibitin arvo 0 indikoi nyt negatiivista lukua ja arvo 1 posiivista lukua.

-- Quiz 3.2.1 Mikä on kokonaisluvun -33 yhden komplementin 8-bittinen esitysmuoto? (monivalinta)
<div><quiznator id="5bdc44630f60f62a209d8e50"></quiznator></div>

-- Quiz 3.2.2 Mikä on kokonaisluvun -40 kahden komplementin 8-bittinen esitysmuoto?
<div><quiznator id="5bdc45abb5cefd2a43d9b2e6"></quiznator></div>

-- Quiz 3.2.3 Mikä on kokonaisluvun +78 vakiolisäys 127 8-bittinen esitysmuoto?
<div><quiznator id="5bdc4a7b8138f12a7e53728a"></quiznator></div>

-- Quiz 3.2.4 Mikä on kokonaisluvun -100 vakiolisäys 127 8-bittinen esitysmuoto?
<div><quiznator id="5bdc4c7ce8e5d029fd781972"></quiznator></div>

-- Quiz 3.2.5 Mitä kokonaislukua 8-bittinen kahden komplementin data 0x63 esittää?
<div><quiznator id="5bdc4e5dc6014229d5b535a1"></quiznator></div>

-- Quiz 3.2.6 Mitä kokonaislukua 8-bittinen vakiolisäys 127 data 0xC3 esittää?
<div><quiznator id="5bdc506ee921f629a8dfd762"></quiznator></div>

-- Quiz 3.2.7 Mitä kokonaislukua 32-bittinen kahden komplementti data 0xFFFFF7D1 esittää?
...
<key-terminology
  terminologies='[
      {"title":"Kahden komplementti", "content":"Kokonaislukujen yleisin esitysmuoto. Negatiivisen luvun esitysmuoto saadaan komplementoimalla positiivisen luvun binääriesitysmuoto ja lisäämällä 1."},
      {"title":"Vakiolisäys-esitysmuoto", "content":"Kokonaisluvun esitysmuoto on positiivinen kokonaisluku, joka saadaan lisäämällä lukuarvoon jokin sovittu vakio. Esimerkiksi, 8-bittiselle tiedolle vakio on yleensä 127."}
  ]'>
</key-terminology>
</div>
...
<pre>+1.23         =    + 1.230000  *  10<sup>0</sup>
...
<pre>+1.5<sub>10</sub>   =   +1.1        =  +  1.10000000    * 2<sup>0</sup>
...
<pre> -96.75<sub>10</sub>   = -1.1000 0011    * 2<sup>6</sup> &rarr; 1 100 0 010 1 100 0001 1000 0000 0000 0000 = 0xC2C18000
</pre>
...
<pre> +345.875<sub>10</sub> = +1.0101 1010 111 * 2<sup>8</sup> &rarr; 0 100 0 011 1 010 1101 0111 0000 0000 0000 = 0x43AD7000
</pre>
...
<pre>0x40780000 = 0 100 0000 0 111 1000 0000 0000 0000 &rarr; +1.1111 * 2<sup>1</sup> = +11.111<sub>2</sub> =  3.875<sub>10</sub>
</pre>
...
<pre>+1.14794*10<sup>-40</sup> = 0.0000 0010 1 * 2<sup>-126</sup> &rarr; 0 000 0000 0 000 0001 0100 0000 0000 0000 = 0x00014000
</pre>
Huonona puolena tällaisissa (itseisarvoltaan) hyvin pienissä luvuissa on esitystarkkuuden heikentyminen. Edellisessä esimerkissä merkitseviä bittejä on vain 17, kun normaalisti liukulukujen tarkkuus on 24 bittiä. Jokainen alkunolla ei-normalisoidussa mantissassa puolittaa lukutarkkuuden.

-- Quiz 3.2.8 Mikä on liukuluvun -8.375 IEEE-standardin mukainen 32-bittinen esitystapa (monivalinta)
<div><quiznator id="5be1890ae8e5d029fd781d84"></quiznator></div>

-- Quiz 3.2.9 Mikä on liukuluvun -1.0 IEEE-standardin mukainen 32-bittinen esitystapa
<div><quiznator id="5be18b670f60f62a209d9293"></quiznator></div>

-- Quiz 3.2.10 Kun liukulukumuuttujan L esitysmuoto on 0x40040000, niin mikä on sen arvo?
