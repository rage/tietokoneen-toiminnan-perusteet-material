...
Järjestelmään kuuluu myös aina jokin [massamuisti](https://fi.wikipedia.org/wiki/Massamuisti), jossa tiedot säilyvät ilman sähkövirtaa. Kun virrat kytketään päälle, järjestelmä alustetaan massamuistissa olevien tietojen avulla. Samassa massamuistissa voi olla tallessa myös kaikki järjestelmän käyttäjien tiedot ja ohjelmien ohjelmakoodit. Massamuisti voi olla esimerkiksi [kovalevy](https://www.wikiwand.com/fi/Kiintolevy), [SSD-levy](https://fi.wikipedia.org/wiki/SSD) tai [USB-muistitikku](https://fi.wikipedia.org/wiki/USB-muisti).
